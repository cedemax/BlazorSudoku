...
namespace SudokuTests.Performance
{
    ...
    public class PerfData : IEnumerable<object[]>
    {
        public static PerfScenario[] Data => new PerfScenario[]
        {
            ...
            new PerfScenario(new HiddenGroup(2), "HiddenPairTest", 1000,20 ),
            new PerfScenario(new HiddenGroup(3), "HiddenTripletTest", 1000,200 ),
            new PerfScenario(new HiddenGroup(4), "HiddenQuadTest", 1000,300 ),
