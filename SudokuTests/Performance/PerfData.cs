...
namespace SudokuTests.Performance
{
    ...
    public class PerfData : IEnumerable<object[]>
    {
        public static PerfScenario[] Data => new PerfScenario[]
        {
            ...
            new PerfScenario(new OnlyOptionNoTick(),"NoTickPerf",1000,80 ),
            new PerfScenario(new SelectOnlies(),"3Star",1000,80 ),
            new PerfScenario(new EliminateDirect(),"3Star",1000,80 ),
            new PerfScenario(new OnlyOption(),"3Star",1000,80 ),
            new PerfScenario(new DomainForcing(),"3Star",1000,80 ),
            ...
            new PerfScenario(new NakedGroup(2), "4Star", 1000,80 ),
            new PerfScenario(new NakedGroup(3), "4Star", 1000,80 ),
            new PerfScenario(new NakedGroup(4), "4Star", 1000,80 ),
